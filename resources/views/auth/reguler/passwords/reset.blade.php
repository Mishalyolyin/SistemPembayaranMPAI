{{-- resources/views/auth/reguler/passwords/reset.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
  <meta charset="UTF-8" />
  <title>Reset Password – Mahasiswa Reguler</title>
  ...
  <style>
    ...
    body{
      min-height:100vh;
      background:
        radial-gradient(950px 600px at 20% 0%, rgba(34,197,94,.22), transparent 55%) no-repeat,
        radial-gradient(900px 600px at 90% 15%, rgba(6,182,212,.18), transparent 55%) no-repeat,
    ...
    .title{color:#f8fafc;margin:0;font-weight:800;letter-spacing:.3px;font-size:1.15rem}
...
<body>
    ...
    <div class="cardx" role="region" aria-labelledby="page-title">
      <div class="head">
        <h1 id="page-title" class="title">
          <i class="bi bi-shield-lock me-2"></i>Reset Password (Mahasiswa Reguler)
        </h1>
      ...
      <div class="content">
        ...
        <form method="POST" action="{{ route('reguler.password.update') }}" class="needs-validation" novalidate>
          @csrf
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              <input
                ...
                minlength="8"
              >
              <span class="input-group-text" role="button" onclick="togglePwd('pwdR','eyeR1')" aria-label="Tampilkan/sembunyikan password baru">
                <i id="eyeR1" class="bi bi-eye"></i>
              </span>
            </div>
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              <input
                ...
                minlength="8"
              >
              <span class="input-group-text" role="button" onclick="togglePwd('pwdR2','eyeR2')" aria-label="Tampilkan/sembunyikan konfirmasi password">
                <i id="eyeR2" class="bi bi-eye"></i>
              </span>
            </div>
          </div>
  ...
  <script>
    function togglePwd(id, eyeId){
      ...
      eye.classList.toggle('bi-eye'); eye.classList.toggle('bi-eye-slash');
    }
